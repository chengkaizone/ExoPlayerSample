package com.tony.exoplayersample.videoedit;
...
public class VideoEditActivity extends AppCompatActivity {
    ...
    private void initData() {
        path = Environment.getExternalStorageDirectory() + File.separator + "Ying_1509427708135.mp4";
        //for video check
        ...
        String timeStr = mExtractVideoInfoUtil.getVideoLength();
        if (timeStr != null) {
            duration = Long.valueOf(timeStr);
        } else {
            duration = 10000;
        }
